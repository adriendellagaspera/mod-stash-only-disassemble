...
It is the **consumer side** of [Immersive Scrapping](../immersive-scrapping/README.md): scrapping
...
- **Adjacency:**
  ...
  [Immersive Scrapping](../immersive-scrapping/README.md) mod (disassemble-side).
- **Rejected:**
